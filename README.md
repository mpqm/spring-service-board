...
| **프로젝트 개발 산출물**  | **링크**                                                                                                           |
|------------------|------------------------------------------------------------------------------------------------------------------|
| 🎡 ERD           | [ERD](https://github.com/mpqm/spring-service-board/tree/main/meta/image/image2.png)                              |
| 🎡 Architecture  | [Architecture](https://github.com/mpqm/spring-service-board/tree/main/meta/image/image1.png)                     |
...
| 🌱 프론트엔드 화면 설계서  | [프론트엔드 화면 설계서](https://www.figma.com/design/9xfCgZEpnGi5GCOSUT1pjf/spring-service-board?node-id=8-2&t=lrUcyQsbjGivJr5w-1)                                                                                           |

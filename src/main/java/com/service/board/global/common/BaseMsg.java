...
public enum BaseMsg {
    ...
    MEMBER_UPDATE_FAIL(1500, false, "회원 정보 업데이트에 실패했습니다."),
    MEMBER_PW_NOT_MATCH(1501, false, "비밀번호가 다릅니다."),
    MEMBER_EMPTY_INPUT(1502, false, "아이디, 비밀번호가 입력되지 않았습니다. 다시 확인해 주세요."),
    MEMBER_CREATE_LOGIN_HISTORY_FAIL(1506, false,"로그인 이력 저장에 실패했습니다."),
    ...
    LIKE_NOT_INCREASED(2016, false, "좋아요 증가에 실패했습니다."),
    LIKE_NOT_DECREASED(2016, false, "좋아요 감소에 실패했습니다."),
    LIKE_NOT_FOUND(2016, false, "좋아요를 찾을 수 없습니다."),
    UNLIKE_NOT_FOUND(2016, false, "싫어요를 찾을 수 없습니다."),
    UNLIKE_INCREASED(2017, true, "싫어요가 증가되었습니다."),
    UNLIKE_DECREASED(2018, true, "싫어요가 감소되었습니다."),
    UNLIKE_NOT_INCREASED(2018, false, "싫어요 증가에 실패했습니다."),
